...
; CHECK-NEXT:    movs r6, #6
; CHECK-NEXT:    ldrsh r2, [r0, r6]
...
; CHECK-NEXT:    str r4, [r1]
; CHECK-NEXT:    lsls r4, r5, #16
; CHECK-NEXT:    str r4, [r1, #8]
; CHECK-NEXT:    lsls r2, r2, #16
; CHECK-NEXT:    str r2, [r1, #12]
; CHECK-NEXT:    movs r2, #14
; CHECK-NEXT:    ldrsh r2, [r0, r2]
; CHECK-NEXT:    movs r4, #10
; CHECK-NEXT:    ldrsh r4, [r0, r4]
; CHECK-NEXT:    lsls r4, r4, #16
...
; CHECK-NEXT:    lsls r2, r2, #16
; CHECK-NEXT:    str r2, [r1, #28]
; CHECK-NEXT:    movs r2, #22
; CHECK-NEXT:    ldrsh r2, [r0, r2]
; CHECK-NEXT:    movs r4, #18
; CHECK-NEXT:    ldrsh r4, [r0, r4]
; CHECK-NEXT:    lsls r4, r4, #16
; CHECK-NEXT:    ldrh r5, [r0, #20]
; CHECK-NEXT:    ldrh r6, [r0, #16]
...
; CHECK-NEXT:    lsls r2, r2, #16
; CHECK-NEXT:    str r2, [r1, #44]
; CHECK-NEXT:    movs r2, #30
; CHECK-NEXT:    ldrsh r2, [r0, r2]
; CHECK-NEXT:    movs r4, #26
; CHECK-NEXT:    ldrsh r4, [r0, r4]
; CHECK-NEXT:    lsls r4, r4, #16
; CHECK-NEXT:    ldrh r5, [r0, #28]
; CHECK-NEXT:    ldrh r6, [r0, #24]
...
; CHECK-NEXT:    ldrh r7, [r0, #8]
; CHECK-NEXT:    lsls r7, r7, #16
; CHECK-NEXT:    lsls r6, r6, #16
; CHECK-NEXT:    lsls r2, r2, #16
; CHECK-NEXT:    str r7, [r1, #16]
; CHECK-NEXT:    str r4, [r1, #20]
