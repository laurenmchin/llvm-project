...
; CHECK-LE-P8-NEXT:    mtfprd f0, r3
; CHECK-LE-P8-NEXT:    xxmrghd v2, v2, vs0
; CHECK-LE-P8-NEXT:    blr
;
; CHECK-LE-P9-LABEL: test_v16i8_v2i64:
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    mtfprd f0, r3
; CHECK-LE-P9-NEXT:    mtvsrdd v2, r4, r4
; CHECK-LE-P9-NEXT:    xxmrghd v2, v2, vs0
; CHECK-LE-P9-NEXT:    blr
;
...
; CHECK-LE-P8-NEXT:    xxswapd v2, vs0
; CHECK-LE-P8-NEXT:    mtfprd f0, r4
; CHECK-LE-P8-NEXT:    xxspltd v3, vs0, 0
; CHECK-LE-P8-NEXT:    xxmrgld v2, v3, v2
; CHECK-LE-P8-NEXT:    blr
;
; CHECK-LE-P9-LABEL: test_none_v2i64:
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lxv v2, 0(r3)
; CHECK-LE-P9-NEXT:    mtvsrdd v3, r4, r4
; CHECK-LE-P9-NEXT:    xxmrgld v2, v3, v2
; CHECK-LE-P9-NEXT:    blr
;
...
; CHECK-LE-P8:       # %bb.0: # %entry
; CHECK-LE-P8-NEXT:    lxvdsx v2, 0, r3
; CHECK-LE-P8-NEXT:    lxvdsx v3, 0, r4
; CHECK-LE-P8-NEXT:    xxmrgld v3, v3, v2
...
; CHECK-LE-P9-NEXT:    xxmrgld v3, v3, v2
...
; CHECK-BE-P9-NEXT:    ld r4, 0(r4)
; CHECK-BE-P9-NEXT:    mtvsrd v2, r3
; CHECK-BE-P9-NEXT:    mtvsrdd v3, r3, r4
...
; CHECK-AIX-64-P8-NEXT:    ld r3, 0(r4)
; CHECK-AIX-64-P8-NEXT:    mtfprd f0, r3
...
; CHECK-AIX-64-P9-NEXT:    ld r4, 0(r4)
; CHECK-AIX-64-P9-NEXT:    mtvsrd v2, r3
; CHECK-AIX-64-P9-NEXT:    mtvsrdd v3, r3, r4
...
; CHECK-AIX-32-P8-NEXT:    lfiwzx f3, 0, r3
; CHECK-AIX-32-P8-NEXT:    lfiwzx f0, r4, r5
; CHECK-AIX-32-P8-NEXT:    lfiwzx f2, r3, r5
...
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs0, vs1, vs0
; CHECK-AIX-32-P8-NEXT:    xxmrghw v2, vs3, vs2
...
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, vs1, vs0
; CHECK-AIX-32-P9-NEXT:    lxvwsx vs1, r3, r5
