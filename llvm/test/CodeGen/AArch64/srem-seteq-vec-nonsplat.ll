...
; CHECK-NEXT:    ldr q1, [x8, :lo12:.LCPI0_2]
...
; CHECK-NEXT:    ushr v3.4s, v1.4s, #31
...
; CHECK-NEXT:    mla v1.4s, v0.4s, v2.4s
; CHECK-NEXT:    ushr v2.4s, v1.4s, #31
...
; CHECK-NEXT:    sshl v2.4s, v1.4s, v2.4s
; CHECK-NEXT:    usra v2.4s, v1.4s, #31
; CHECK-NEXT:    ldr q1, [x8, :lo12:.LCPI7_2]
; CHECK-NEXT:    mls v0.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v1.4s, #1
; CHECK-NEXT:    cmeq v0.4s, v0.4s, #0
; CHECK-NEXT:    and v0.16b, v0.16b, v1.16b
...
; CHECK-NEXT:    ldr q3, [x8, :lo12:.LCPI9_1]
...
; CHECK-NEXT:    ushr v2.4s, v1.4s, #31
; CHECK-NEXT:    add v1.4s, v1.4s, v3.4s
; CHECK-NEXT:    ldr q3, [x8, :lo12:.LCPI10_1]
...
; CHECK-NEXT:    ldr q4, [x9, :lo12:.LCPI20_3]
; CHECK-NEXT:    smull2 v2.2d, v0.4s, v1.4s
; CHECK-NEXT:    smull v1.2d, v0.2s, v1.2s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
...
; CHECK-NEXT:    ldr q4, [x9, :lo12:.LCPI21_3]
; CHECK-NEXT:    smull2 v2.2d, v0.4s, v1.4s
; CHECK-NEXT:    smull v1.2d, v0.2s, v1.2s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
...
; CHECK-NEXT:    ldr q3, [x8, :lo12:.LCPI22_1]
...
; CHECK-NEXT:    ldr q3, [x8, :lo12:.LCPI23_1]
...
; CHECK-NEXT:    ldr q3, [x8, :lo12:.LCPI24_1]
...
; CHECK-NEXT:    ushr v3.4s, v1.4s, #31
; CHECK-NEXT:    sshl v1.4s, v1.4s, v4.4s
