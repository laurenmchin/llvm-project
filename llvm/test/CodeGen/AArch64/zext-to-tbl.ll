...
; CHECK-BE-NEXT:    ld1 { v0.16b }, [x8]
; CHECK-BE-NEXT:    ld1 { v1.16b }, [x9]
; CHECK-BE-NEXT:    usubl2 v2.8h, v0.16b, v1.16b
; CHECK-BE-NEXT:    usubl v0.8h, v0.8b, v1.8b
; CHECK-BE-NEXT:    sshll v1.4s, v2.4h, #0
; CHECK-BE-NEXT:    sshll2 v3.4s, v0.8h, #0
; CHECK-BE-NEXT:    sshll2 v2.4s, v2.8h, #0
; CHECK-BE-NEXT:    sshll v0.4s, v0.4h, #0
; CHECK-BE-NEXT:    abs v1.4s, v1.4s
; CHECK-BE-NEXT:    abs v2.4s, v2.4s
; CHECK-BE-NEXT:    abs v3.4s, v3.4s
; CHECK-BE-NEXT:    abs v0.4s, v0.4s
; CHECK-BE-NEXT:    add v2.4s, v3.4s, v2.4s
