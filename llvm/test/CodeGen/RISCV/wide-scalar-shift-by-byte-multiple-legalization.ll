...
; RV64I-NEXT:    lbu s5, 31(a0)
; RV64I-NEXT:    slli s9, s9, 8
; RV64I-NEXT:    slli s10, s10, 16
; RV64I-NEXT:    slli s11, s11, 24
; RV64I-NEXT:    slli s6, t5, 8
; RV64I-NEXT:    slli s0, s0, 16
; RV64I-NEXT:    slli s1, s1, 24
; RV64I-NEXT:    or a0, s9, s8
; RV64I-NEXT:    or t5, s11, s10
; RV64I-NEXT:    or t6, s6, t6
; RV64I-NEXT:    or s0, s1, s0
; RV64I-NEXT:    lbu s1, 0(a1)
; RV64I-NEXT:    lbu s6, 1(a1)
...
; RV64I-NEXT:    lbu s5, 5(a1)
; RV64I-NEXT:    lbu s7, 4(a1)
; RV64I-NEXT:    lbu s8, 6(a1)
; RV64I-NEXT:    lbu a1, 7(a1)
; RV64I-NEXT:    slli s5, s5, 8
; RV64I-NEXT:    or s5, s5, s7
...
; RV64I-NEXT:    or s6, s6, s1
; RV64I-NEXT:    slli s1, s1, 2
; RV64I-NEXT:    andi s1, s1, 24
; RV64I-NEXT:    or a3, a6, a3
; RV64I-NEXT:    or a6, t0, a7
; RV64I-NEXT:    or a7, t2, t1
; RV64I-NEXT:    or t0, t4, t3
; RV64I-NEXT:    or a0, t5, a0
; RV64I-NEXT:    or t1, s0, t6
; RV64I-NEXT:    or t2, s3, s2
; RV64I-NEXT:    or t3, s4, s6
; RV64I-NEXT:    or a1, a1, s5
; RV64I-NEXT:    add a5, a5, s1
...
; RV64I-NEXT:    srli s0, t2, 24
; RV64I-NEXT:    srli s1, t2, 16
; RV64I-NEXT:    srli s2, t2, 8
...
; RV64I-NEXT:    srli t2, a4, 56
; RV64I-NEXT:    srli t3, a4, 48
; RV64I-NEXT:    srli t4, a4, 40
...
; RV64I-NEXT:    slli a5, a5, 16
; RV64I-NEXT:    slli a6, a6, 24
; RV64I-NEXT:    slli s9, t0, 8
; RV64I-NEXT:    or t0, a4, a3
; RV64I-NEXT:    or t1, a6, a5
; RV64I-NEXT:    or a3, s9, a7
...
; RV64I-NEXT:    or a4, t3, t2
; RV64I-NEXT:    or a5, t5, t4
; RV64I-NEXT:    or a6, s0, t6
; RV64I-NEXT:    or a7, s2, s1
; RV64I-NEXT:    lbu t6, 24(a0)
; RV64I-NEXT:    lbu t5, 25(a0)
; RV64I-NEXT:    lbu s0, 26(a0)
; RV64I-NEXT:    lbu s1, 27(a0)
...
; RV64I-NEXT:    slli s7, s7, 16
; RV64I-NEXT:    slli s8, s8, 24
; RV64I-NEXT:    or t2, s4, s3
; RV64I-NEXT:    or t3, s6, s5
; RV64I-NEXT:    or t4, s8, s7
; RV64I-NEXT:    lbu s2, 28(a0)
; RV64I-NEXT:    lbu s3, 29(a0)
; RV64I-NEXT:    lbu s4, 30(a0)
; RV64I-NEXT:    lbu s5, 31(a0)
...
; RV64I-NEXT:    slli s0, s0, 16
; RV64I-NEXT:    slli s1, s1, 24
; RV64I-NEXT:    or a0, s10, s9
; RV64I-NEXT:    or t5, ra, s11
; RV64I-NEXT:    or t6, s6, t6
; RV64I-NEXT:    or s0, s1, s0
; RV64I-NEXT:    lbu s1, 0(a1)
; RV64I-NEXT:    lbu s6, 1(a1)
...
; RV64I-NEXT:    or a3, a4, a3
; RV64I-NEXT:    or a4, a6, a5
; RV64I-NEXT:    or a5, t2, a7
; RV64I-NEXT:    or a6, t4, t3
; RV64I-NEXT:    or a0, t5, a0
; RV64I-NEXT:    or a7, s0, t6
; RV64I-NEXT:    or t2, s3, s2
; RV64I-NEXT:    or t3, s4, s6
; RV64I-NEXT:    or a1, a1, s5
; RV64I-NEXT:    add t1, t1, s1
; RV64I-NEXT:    slli a3, a3, 32
; RV64I-NEXT:    slli a5, a5, 32
; RV64I-NEXT:    slli a0, a0, 32
; RV64I-NEXT:    slli t4, t2, 32
; RV64I-NEXT:    slli a1, a1, 32
; RV64I-NEXT:    sraiw t2, t2, 31
; RV64I-NEXT:    or a3, a3, t0
; RV64I-NEXT:    or a4, a5, a4
; RV64I-NEXT:    or a0, a0, a6
; RV64I-NEXT:    or a5, t4, a7
; RV64I-NEXT:    or a1, a1, t3
; RV64I-NEXT:    sd t2, 32(sp)
; RV64I-NEXT:    sd t2, 40(sp)
; RV64I-NEXT:    sd t2, 48(sp)
; RV64I-NEXT:    sd t2, 56(sp)
; RV64I-NEXT:    sd a3, 0(sp)
; RV64I-NEXT:    sd a4, 8(sp)
; RV64I-NEXT:    sd a0, 16(sp)
; RV64I-NEXT:    sd a5, 24(sp)
...
; RV64I-NEXT:    ld a4, 8(t1)
; RV64I-NEXT:    ld a5, 16(t1)
; RV64I-NEXT:    ld a6, 24(t1)
; RV64I-NEXT:    not a7, a3
; RV64I-NEXT:    xori t0, a0, 63
; RV64I-NEXT:    srl a0, a1, a3
; RV64I-NEXT:    slli t1, a4, 1
; RV64I-NEXT:    srl t2, a5, a3
; RV64I-NEXT:    slli t3, a6, 1
; RV64I-NEXT:    srl a1, a4, a3
; RV64I-NEXT:    slli a5, a5, 1
; RV64I-NEXT:    sra a3, a6, a3
; RV64I-NEXT:    sll a4, t1, t0
; RV64I-NEXT:    sll a6, t3, t0
