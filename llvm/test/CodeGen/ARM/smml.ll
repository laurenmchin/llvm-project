...
; CHECK-V4-NEXT:    mov r0, #0
; CHECK-V4-NEXT:    rsbs r1, r2, #0
; CHECK-V4-NEXT:    rscs r1, r3, #0
; CHECK-V4-NEXT:    movlt r0, #1
; CHECK-V4-NEXT:    cmp r0, #0
; CHECK-V4-NEXT:    moveq r0, #42
; CHECK-V4-NEXT:    movne r0, #56
...
; CHECK-THUMB-NEXT:    rsbs r0, r0, #0
; CHECK-THUMB-NEXT:    mov r12, r2
; CHECK-THUMB-NEXT:    mov r0, r12
; CHECK-THUMB-NEXT:    sbcs r0, r1
...
; CHECK-THUMB-NEXT:    beq .LBB2_4
; CHECK-THUMB-NEXT:  @ %bb.3: @ %false
; CHECK-THUMB-NEXT:    movs r0, #56
; CHECK-THUMB-NEXT:    b .LBB2_5
; CHECK-THUMB-NEXT:  .LBB2_4: @ %true
; CHECK-THUMB-NEXT:    movs r0, #42
; CHECK-THUMB-NEXT:  .LBB2_5: @ %true
...
; CHECK-THUMBV6-NEXT:    rsbs r0, r0, #0
; CHECK-THUMBV6-NEXT:    mov r0, r2
; CHECK-THUMBV6-NEXT:    sbcs r0, r1
; CHECK-THUMBV6-NEXT:    bge .LBB2_2
; CHECK-THUMBV6-NEXT:  @ %bb.1:
; CHECK-THUMBV6-NEXT:    movs r2, #1
; CHECK-THUMBV6-NEXT:  .LBB2_2:
; CHECK-THUMBV6-NEXT:    cmp r2, #0
; CHECK-THUMBV6-NEXT:    beq .LBB2_4
; CHECK-THUMBV6-NEXT:  @ %bb.3: @ %false
; CHECK-THUMBV6-NEXT:    movs r0, #56
; CHECK-THUMBV6-NEXT:    bl opaque
; CHECK-THUMBV6-NEXT:    pop {r7, pc}
; CHECK-THUMBV6-NEXT:  .LBB2_4: @ %true
...
; CHECK-THUMBV6T2-NEXT:    it lt
; CHECK-THUMBV6T2-NEXT:    movlt r2, #1
; CHECK-THUMBV6T2-NEXT:    cmp r2, #0
; CHECK-THUMBV6T2-NEXT:    ite ne
; CHECK-THUMBV6T2-NEXT:    movne r0, #56
; CHECK-THUMBV6T2-NEXT:    moveq r0, #42
