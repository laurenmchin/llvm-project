...
; CHECK-ARMV5TE-NEXT:    ldrb r5, [r0, #2]
; CHECK-ARMV5TE-NEXT:    ldrb r0, [r0, #3]
...
; CHECK-ARMV4T-NEXT:    ldrb r5, [r0, #2]
; CHECK-ARMV4T-NEXT:    ldrb r0, [r0, #3]
...
; CHECK-ARMV7-STRICT-NEXT:    ldrb r2, [r1, #4]!
...
; CHECK-ARMV7-STRICT-NEXT:    strb r1, [r6, #7]
...
; CHECK-ARMV6-STRICT-NEXT:    ldrb r5, [r0, #2]
; CHECK-ARMV6-STRICT-NEXT:    ldrb r0, [r0, #3]
