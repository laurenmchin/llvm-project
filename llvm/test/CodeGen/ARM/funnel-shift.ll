...
; CHECK-NEXT:    tst r1, r2, lsr #5
; CHECK-NEXT:    mov r1, r8
; CHECK-NEXT:    and r3, r2, #31
; CHECK-NEXT:    movne r1, r0
; CHECK-NEXT:    lslne r0, r7, #27
; CHECK-NEXT:    mov r5, #31
; CHECK-NEXT:    bic r2, r5, r2
; CHECK-NEXT:    lsl r6, r1, r3
; CHECK-NEXT:    lsr r0, r0, #1
; CHECK-NEXT:    movne r4, r8
; CHECK-NEXT:    lsr r1, r1, #1
; CHECK-NEXT:    lsl r3, r4, r3
; CHECK-NEXT:    orr r0, r6, r0, lsr r2
; CHECK-NEXT:    orr r1, r3, r1, lsr r2
