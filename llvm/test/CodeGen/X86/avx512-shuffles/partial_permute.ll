...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [3,9,11,10,7,13,15,14]
; CHECK-NEXT:    vpermd (%rdi), %zmm2, %zmm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [3,9,11,10,7,13,15,14]
; CHECK-NEXT:    vpermd (%rdi), %zmm1, %zmm1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [8,2,10,3,12,6,14,7]
; CHECK-NEXT:    vpermps (%rdi), %zmm2, %zmm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [8,2,10,3,12,6,14,7]
; CHECK-NEXT:    vpermps (%rdi), %zmm1, %zmm1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [8,2,10,11,12,6,14,15]
; CHECK-NEXT:    vpermps (%rdi), %zmm2, %zmm2
; CHECK-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,2,2,2]
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
; CHECK-NEXT:    vcmpeqps %xmm3, %xmm1, %k1
; CHECK-NEXT:    vmovaps %xmm2, %xmm0 {%k1}
; CHECK-NEXT:    vzeroupper
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [8,2,10,11,12,6,14,15]
; CHECK-NEXT:    vpermps (%rdi), %zmm1, %zmm1
