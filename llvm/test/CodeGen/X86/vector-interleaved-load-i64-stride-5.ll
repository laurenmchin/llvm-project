...
; AVX-NEXT:    vshufpd {{.*#+}} ymm14 = ymm14[0],ymm3[1],ymm14[3],ymm3[2]
...
; AVX-NEXT:    vinsertf128 $1, 256(%rdi), %ymm0, %ymm15
; AVX-NEXT:    vshufpd {{.*#+}} ymm15 = ymm15[0],ymm14[1],ymm15[3],ymm14[2]
; AVX-NEXT:    vmovdqa 224(%rdi), %xmm0
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm11 = ymm11[0],ymm15[1],ymm11[3],ymm15[2]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[0],ymm13[1],ymm3[3],ymm13[2]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm12 = ymm0[0],ymm1[1],ymm0[3],ymm1[2]
...
; AVX2-NEXT:    vmovdqa 448(%rdi), %ymm14
; AVX2-NEXT:    vpalignr $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm12 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm12 = mem[8,9,10,11,12,13,14,15],ymm14[0,1,2,3,4,5,6,7],mem[24,25,26,27,28,29,30,31],ymm14[16,17,18,19,20,21,22,23]
...
; AVX2-NEXT:    vpalignr {{.*#+}} ymm3 = ymm9[8,9,10,11,12,13,14,15],ymm15[0,1,2,3,4,5,6,7],ymm9[24,25,26,27,28,29,30,31],ymm15[16,17,18,19,20,21,22,23]
...
; AVX2-FP-NEXT:    vmovdqa 448(%rdi), %ymm14
; AVX2-FP-NEXT:    vpalignr $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm12 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm12 = mem[8,9,10,11,12,13,14,15],ymm14[0,1,2,3,4,5,6,7],mem[24,25,26,27,28,29,30,31],ymm14[16,17,18,19,20,21,22,23]
...
; AVX2-FP-NEXT:    vpalignr {{.*#+}} ymm3 = ymm9[8,9,10,11,12,13,14,15],ymm15[0,1,2,3,4,5,6,7],ymm9[24,25,26,27,28,29,30,31],ymm15[16,17,18,19,20,21,22,23]
...
; AVX2-FCP-NEXT:    vmovdqa 448(%rdi), %ymm14
; AVX2-FCP-NEXT:    vpalignr $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm12 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm12 = mem[8,9,10,11,12,13,14,15],ymm14[0,1,2,3,4,5,6,7],mem[24,25,26,27,28,29,30,31],ymm14[16,17,18,19,20,21,22,23]
...
; AVX2-FCP-NEXT:    vpalignr {{.*#+}} ymm3 = ymm9[8,9,10,11,12,13,14,15],ymm15[0,1,2,3,4,5,6,7],ymm9[24,25,26,27,28,29,30,31],ymm15[16,17,18,19,20,21,22,23]
