...
; RUN: llc < %s -mtriple=x86_64-pc-linux -mattr=+sse2,+fast-vector-shift-masks | FileCheck %s --check-prefixes=CHECK,SHIFT,SHIFT-FAST
; RUN: llc < %s -mtriple=x86_64-pc-linux -mcpu=btver1 | FileCheck %s --check-prefixes=CHECK,SHIFT,SHIFT-SLOW
...
; MASK-NEXT:    retq
;
; SHIFT-FAST-LABEL: sra_trunc_srl_v4i32:
; SHIFT-FAST:       # %bb.0:
; SHIFT-FAST-NEXT:    psrad $19, %xmm0
; SHIFT-FAST-NEXT:    pextrw $6, %xmm0, %eax
; SHIFT-FAST-NEXT:    pextrw $4, %xmm0, %ecx
; SHIFT-FAST-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7]
; SHIFT-FAST-NEXT:    pinsrw $2, %ecx, %xmm0
; SHIFT-FAST-NEXT:    pinsrw $3, %eax, %xmm0
; SHIFT-FAST-NEXT:    retq
;
; SHIFT-SLOW-LABEL: sra_trunc_srl_v4i32:
; SHIFT-SLOW:       # %bb.0:
; SHIFT-SLOW-NEXT:    psrad $19, %xmm0
; SHIFT-SLOW-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[0,1,4,5,8,9,12,13,8,9,10,11,12,13,14,15]
; SHIFT-SLOW-NEXT:    retq
