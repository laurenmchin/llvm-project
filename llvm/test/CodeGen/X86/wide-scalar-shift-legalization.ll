...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $96, %cl
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $96, %al
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, -72(%rsp,%rcx), %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%rcx), %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%rcx), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %rdi, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %r8, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -48(%rsp,%rcx), %rcx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $-32, %cl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrb $3, %cl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movzbl %cl, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, 16(%esp,%ecx), %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %ebp, %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 32(%esp,%ecx), %esi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%ecx), %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edx, (%esp) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%ecx), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%edx,%edx), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %esi, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl (%esp), %esi # 4-byte Folded Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %edx, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 44(%esp,%ecx), %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %ecx, %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    addl %ecx, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %ecx, %ecx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %esi, 20(%edx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, 16(%edx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, 12(%edx)
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 12(%ecx), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 16(%ecx), %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 20(%ecx), %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $-32, %al
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrb $3, %al
; X86-HAVE-BMI2-NO-SHLD-NEXT:    negb %al
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movsbl %al, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 64(%esp,%esi), %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 68(%esp,%esi), %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 76(%esp,%esi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %eax, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edi, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %eax, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 80(%esp,%esi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %eax, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edi, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %eax, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 84(%esp,%esi), %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, 92(%esp,%esi), %ebx
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -112(%rsp,%rax), %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %rdi, %rbp
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r14, %rsi
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -88(%rsp,%rax), %r12
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r12, %r13
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, %r15d
; X64-HAVE-BMI2-NO-SHLD-NEXT:    xorb $63, %r15b
; X64-HAVE-BMI2-NO-SHLD-NEXT:    addq %rdi, %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %rdi, %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r8, %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r14,%r14), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %r8, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rbp, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -80(%rsp,%rax), %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r14, %rbp
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %r9, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rsi, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r11,%r11), %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %rsi, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r10, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r12,%r12), %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %r10, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rbx, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r14,%r14), %r11
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %r11, %r11
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r13, %r11
; X64-HAVE-BMI2-NO-SHLD-NEXT:    addq %rax, %rax
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %r15, %rax, %rax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, 48(%esp,%eax), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 52(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %esi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    xorb $31, %bl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 56(%esp,%eax), %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %esi, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 96(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %edi, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %esi, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edx, (%esp) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 100(%esp,%eax), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%edx,%edx), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %esi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl (%esp), %edi # 4-byte Folded Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %edx, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edx, (%esp) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 104(%esp,%eax), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%edx,%edx), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %esi, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl (%esp), %esi # 4-byte Folded Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %edx, %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, 44(%eax)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rax, -8(%rsp,%rcx), %r11
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %r13, %r14, %rbx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rbp, %rbx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrq %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %r13, %r8, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rax, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrq %rcx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %r13, %rcx, %rax
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r11, %rax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    xorb $31, %bl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %ecx, %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 8(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %eax, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 12(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %eax, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 28(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %eax, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 40(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %eax, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 44(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %eax, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 48(%edi), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    negl %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, 188(%esp,%esi), %esi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, (%eax)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %esi, 60(%eax)
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %edx, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 108(%esp,%eax), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    sarxl %ecx, %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    addl %eax, %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %eax, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edx, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %eax
