...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [0,2,12,14,1,3,13,15]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [0,2,12,14,1,3,13,15]
...
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} ymm1 = [0,4,16,20,1,5,17,21,26,30,10,14,27,31,11,15]
; AVX512BW-NEXT:    vpermi2w %ymm0, %ymm2, %ymm1
; AVX512BW-NEXT:    vmovdqa %ymm1, (%r8)
...
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} ymm1 = [0,4,16,20,1,5,17,21,26,30,10,14,27,31,11,15]
; AVX512DQ-BW-NEXT:    vpermi2w %ymm0, %ymm2, %ymm1
; AVX512DQ-BW-NEXT:    vmovdqa %ymm1, (%r8)
...
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512-NEXT:    vpermt2d %ymm2, %ymm10, %ymm4
...
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm9, %zmm2, %zmm0
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512-FCP-NEXT:    vpermt2d %ymm2, %ymm10, %ymm4
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX512-FCP-NEXT:    vpermt2d %ymm1, %ymm10, %ymm2
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm4, %zmm2, %zmm1
...
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm9, %zmm2, %zmm0
...
; AVX512DQ-NEXT:    vpermt2d %ymm2, %ymm10, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm9, %zmm2, %zmm0
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512DQ-FCP-NEXT:    vpermt2d %ymm2, %ymm10, %ymm4
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %ymm1, %ymm10, %ymm2
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm4, %zmm2, %zmm1
...
; AVX512-FCP-NEXT:    vmovdqa 48(%rsi), %xmm1
...
; AVX512-FCP-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
...
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rsi), %xmm1
...
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,16,16,17,17,18,18,19,19]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm1, %zmm13
; AVX512-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-FCP-NEXT:    kmovw %eax, %k1
; AVX512-FCP-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX512-FCP-NEXT:    vpermt2d %zmm11, %zmm1, %zmm12
; AVX512-FCP-NEXT:    vmovdqa32 %zmm12, %zmm2 {%k1}
...
; AVX512-FCP-NEXT:    vmovdqa32 %zmm9, %zmm3 {%k1}
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm1, %zmm6
; AVX512-FCP-NEXT:    vmovdqa32 %zmm6, %zmm4 {%k1}
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512-FCP-NEXT:    vpermt2d %zmm8, %zmm1, %zmm6
...
; AVX512-FCP-NEXT:    vpermt2d %zmm9, %zmm1, %zmm7
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512-FCP-NEXT:    vpermt2d %zmm10, %zmm1, %zmm8
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512-FCP-NEXT:    vpermt2d %zmm11, %zmm1, %zmm9
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,16,16,17,17,18,18,19,19]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm1, %zmm13
; AVX512DQ-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm11, %zmm1, %zmm12
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm12, %zmm2 {%k1}
...
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm9, %zmm3 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm1, %zmm6
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm6, %zmm4 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm8, %zmm1, %zmm6
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm6, %zmm5 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm9, %zmm1, %zmm7
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm10, %zmm1, %zmm8
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm11, %zmm1, %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm9, %zmm8 {%k1}
