...
; AVX512VL-NEXT:    retq
;
; AVX512DQVL-LABEL: PR32547:
; AVX512DQVL:       ## %bb.0: ## %entry
; AVX512DQVL-NEXT:    vcmpltps %ymm1, %ymm0, %k0
; AVX512DQVL-NEXT:    vcmpltps %ymm3, %ymm2, %k1
; AVX512DQVL-NEXT:    kmovw %k0, %eax
; AVX512DQVL-NEXT:    kmovb %k1, %ecx
; AVX512DQVL-NEXT:    shll $8, %eax
; AVX512DQVL-NEXT:    orl %ecx, %eax
; AVX512DQVL-NEXT:    kmovw %eax, %k1
; AVX512DQVL-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; AVX512DQVL-NEXT:    vmovaps %zmm0, (%rdi) {%k1}
