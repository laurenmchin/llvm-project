...
; GCN-DAZ-NEXT:    s_mov_b32 s2, 0xf800000
...
; GCN-DAZ-NEXT:    v_cmp_gt_f32_e32 vcc, s2, v0
...
; GCN-DAZ-NEXT:    v_fma_f32 v4, -v3, v3, v0
; GCN-DAZ-NEXT:    v_fma_f32 v1, v4, v1, v3
...
; GCN-DAZ-NEXT:    v_fma_f32 v3, -v2, v2, v0
; GCN-DAZ-NEXT:    v_fma_f32 v1, v3, v1, v2
...
; GCN-DAZ-NEXT:    s_mov_b32 s9, s3
; GCN-DAZ-NEXT:    buffer_load_dword v0, off, s[8:11], 0
; GCN-DAZ-NEXT:    s_mov_b32 s2, 0x8f800000
; GCN-DAZ-NEXT:    v_mov_b32_e32 v2, 0x260
; GCN-DAZ-NEXT:    s_mov_b32 s4, s0
; GCN-DAZ-NEXT:    s_mov_b32 s5, s1
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-DAZ-NEXT:    v_mul_f32_e64 v2, -v1, s5
; GCN-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v1
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v1, -v1, v2, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v2, v1
; GCN-DAZ-NEXT:    v_mul_f32_e32 v3, v1, v2
; GCN-DAZ-NEXT:    v_mul_f32_e32 v2, 0.5, v2
; GCN-DAZ-NEXT:    v_fma_f32 v4, -v2, v3, 0.5
; GCN-DAZ-NEXT:    v_fma_f32 v3, v3, v4, v3
; GCN-DAZ-NEXT:    v_fma_f32 v5, -v3, v3, v1
...
; GCN-DAZ-NEXT:    v_mul_f32_e64 v3, -v0, s5
; GCN-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v0, -v0, v3, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v3, v0
; GCN-DAZ-NEXT:    v_mov_b32_e32 v4, 0x260
; GCN-DAZ-NEXT:    v_cmp_class_f32_e64 s[4:5], v1, v4
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s[4:5]
; GCN-DAZ-NEXT:    v_mul_f32_e32 v2, v0, v3
...
; GCN-DAZ-NEXT:    v_mul_f32_e32 v3, 0x37800000, v2
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GCN-DAZ-NEXT:    v_cmp_class_f32_e32 vcc, v0, v4
...
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-DAZ-NEXT:    s_mov_b32 s4, 0x8f800000
; GCN-DAZ-NEXT:    v_mul_f32_e32 v2, 0xcf800000, v0
; GCN-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v0, -v0, v2, vcc
...
; GCN-DAZ-NEXT:    v_mul_f32_e32 v3, 0x37800000, v2
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GCN-DAZ-NEXT:    v_mov_b32_e32 v3, 0x260
; GCN-DAZ-NEXT:    v_cmp_class_f32_e32 vcc, v0, v3
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v0, v2, v0, vcc
; GCN-DAZ-NEXT:    v_rcp_f32_e64 v0, -v0
...
; GCN-DAZ-NEXT:    s_mov_b32 s4, 0x8f800000
; GCN-DAZ-NEXT:    s_mov_b32 s5, 0x4f800000
; GCN-DAZ-NEXT:    v_mul_f32_e64 v4, -v1, s5
; GCN-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v1
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v1, -v1, v4, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v4, v1
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, v1, v4
; GCN-DAZ-NEXT:    v_mul_f32_e32 v4, 0.5, v4
; GCN-DAZ-NEXT:    v_fma_f32 v6, -v4, v5, 0.5
; GCN-DAZ-NEXT:    v_fma_f32 v5, v5, v6, v5
; GCN-DAZ-NEXT:    v_fma_f32 v7, -v5, v5, v1
; GCN-DAZ-NEXT:    v_fma_f32 v4, v4, v6, v4
; GCN-DAZ-NEXT:    v_fma_f32 v4, v7, v4, v5
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, 0x37800000, v4
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
; GCN-DAZ-NEXT:    v_mul_f32_e64 v5, -v0, s5
; GCN-DAZ-NEXT:    v_cmp_lt_f32_e32 vcc, s4, v0
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v0, -v0, v5, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v5, v0
; GCN-DAZ-NEXT:    v_mov_b32_e32 v6, 0x260
; GCN-DAZ-NEXT:    v_cmp_class_f32_e64 s[4:5], v1, v6
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v1, v4, v1, s[4:5]
; GCN-DAZ-NEXT:    v_mul_f32_e32 v4, v0, v5
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, 0.5, v5
; GCN-DAZ-NEXT:    v_fma_f32 v7, -v5, v4, 0.5
; GCN-DAZ-NEXT:    v_fma_f32 v4, v4, v7, v4
; GCN-DAZ-NEXT:    v_fma_f32 v8, -v4, v4, v0
; GCN-DAZ-NEXT:    v_fma_f32 v5, v5, v7, v5
; GCN-DAZ-NEXT:    v_fma_f32 v4, v8, v5, v4
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, 0x37800000, v4
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
; GCN-DAZ-NEXT:    v_cmp_class_f32_e32 vcc, v0, v6
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v0, v4, v0, vcc
; GCN-DAZ-NEXT:    v_rcp_f32_e64 v0, -v0
; GCN-DAZ-NEXT:    v_rcp_f32_e64 v1, -v1
...
; GCN-DAZ-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-DAZ-NEXT:    s_mov_b32 s4, 0xf800000
; GCN-DAZ-NEXT:    v_mul_f32_e32 v2, 0x4f800000, v1
...
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, 0x37800000, v4
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
; GCN-DAZ-NEXT:    v_mul_f32_e32 v5, 0x4f800000, v0
; GCN-DAZ-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; GCN-DAZ-NEXT:    v_cndmask_b32_e32 v0, v0, v5, vcc
; GCN-DAZ-NEXT:    v_rsq_f32_e32 v5, v0
; GCN-DAZ-NEXT:    v_mov_b32_e32 v6, 0x260
; GCN-DAZ-NEXT:    v_cmp_class_f32_e64 s[4:5], v1, v6
; GCN-DAZ-NEXT:    v_cndmask_b32_e64 v1, v4, v1, s[4:5]
