...
; CHECK-NEXT:    s_addc_u32 flat_scratch_hi, s13, 0
; CHECK-NEXT:    ds_read2_b64 v[0:3], v26 offset0:12 offset1:13
; CHECK-NEXT:    ds_read2_b64 v[4:7], v26 offset0:14 offset1:15
; CHECK-NEXT:    ds_read2_b64 v[8:11], v26 offset0:4 offset1:5
; CHECK-NEXT:    ds_read2_b64 v[12:15], v26 offset0:6 offset1:7
; CHECK-NEXT:    ds_read2_b64 v[16:19], v26 offset0:8 offset1:9
; CHECK-NEXT:    ds_read2_b64 v[20:23], v26 offset0:10 offset1:11
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v25, s1
; CHECK-NEXT:    v_mov_b32_e32 v24, s0
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[4:7] offset:112
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[0:3] offset:96
; CHECK-NEXT:    ds_read2_b64 v[0:3], v26 offset1:1
; CHECK-NEXT:    ds_read2_b64 v[4:7], v26 offset0:2 offset1:3
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[20:23] offset:80
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[16:19] offset:64
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[12:15] offset:48
; CHECK-NEXT:    flat_store_dwordx4 v[24:25], v[8:11] offset:32
