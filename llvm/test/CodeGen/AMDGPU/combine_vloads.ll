...
; EG-NEXT:    TEX 1 @12
; EG-NEXT:    ALU 87, @20, KC0[], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T14.XY, T15.X, 0
; EG-NEXT:    ALU_PUSH_BEFORE 4, @108, KC0[], KC1[]
...
; EG-NEXT:     LSHR T1.Y, T14.X, literal.x,
; EG-NEXT:     LSHR T1.Z, T14.Z, literal.x,
; EG-NEXT:     ADD_INT T2.W, PV.Y, PV.Z,
; EG-NEXT:     LSHR * T3.W, T15.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T18.X, PV.W, PS,
; EG-NEXT:     ADD_INT T0.Y, PV.Y, PV.Z,
; EG-NEXT:     ADD_INT T0.Z, T14.X, T14.Z,
; EG-NEXT:     LSHR T2.W, T14.Y, literal.x,
; EG-NEXT:     LSHR * T3.W, T14.W, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T19.X, T14.Y, T14.W,
; EG-NEXT:     ADD_INT T1.Y, PV.W, PS,
; EG-NEXT:     LSHR T1.Z, T15.Y, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T2.W, T14.X, literal.x,
; EG-NEXT:     LSHR * T3.W, T14.Z, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T14.X, PV.W, PS,
; EG-NEXT:     LSHR T2.Y, T15.X, literal.x,
; EG-NEXT:     ADD_INT T1.Z, PV.Y, PV.Z,
; EG-NEXT:     LSHR T2.W, T15.W, literal.x,
; EG-NEXT:     ADD_INT * T3.W, PV.X, T15.Y,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T19.X, PS, T15.W,
; EG-NEXT:     ADD_INT T1.Y, PV.Z, PV.W,
; EG-NEXT:     ADD_INT T1.Z, PV.X, PV.Y,
; EG-NEXT:     LSHR T2.W, T15.Z, literal.x,
; EG-NEXT:     ADD_INT * T3.W, T0.Z, T15.X,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     LSHR T14.X, T15.X, literal.x,
; EG-NEXT:     ADD_INT T2.Y, PS, T15.Z,
; EG-NEXT:     ADD_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     LSHL T2.W, PV.Y, literal.y,
; EG-NEXT:     AND_INT * T3.W, PV.X, literal.z,
; EG-NEXT:    16(2.242078e-44), 8(1.121039e-44)
; EG-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; EG-NEXT:     OR_INT T19.X, PS, PV.W,
; EG-NEXT:     LSHL T1.Y, PV.Z, literal.x,
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; EG-NEXT:     ADD_INT T2.W, T0.Y, PV.X,
; EG-NEXT:     LSHR * T3.W, T15.Z, literal.z,
; EG-NEXT:    8(1.121039e-44), 255(3.573311e-43)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     LSHR T14.X, T15.X, literal.x,
; EG-NEXT:     ADD_INT T0.Y, PV.W, PS,
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.Y,
; EG-NEXT:     AND_INT T2.W, PV.X, literal.y,
; EG-NEXT:     LSHL * T3.W, T18.X, literal.z,
; EG-NEXT:    24(3.363116e-44), 65535(9.183409e-41)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     OR_INT T15.X, PV.W, PS,
; EG-NEXT:     AND_INT T1.Y, PV.Z, literal.x,
; EG-NEXT:     LSHL T0.Z, PV.Y, literal.y,
; EG-NEXT:     ADD_INT T2.W, T17.X, PV.X,
; EG-NEXT:     LSHR * T3.W, T15.Z, literal.z,
