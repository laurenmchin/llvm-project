...
; CHECK-NEXT:    adds.w lr, r3, r0
; CHECK-NEXT:    lsr.w r4, r1, #31
; CHECK-NEXT:    adc.w r0, r2, r1
; CHECK-NEXT:    subs.w r3, lr, r3
; CHECK-NEXT:    sbcs.w r2, r0, r2
; CHECK-NEXT:    it lt
; CHECK-NEXT:    eorlt.w r4, r12, r1, lsr #31
