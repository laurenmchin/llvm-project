...
; CHECK-LE-NEXT:    csetm r4, lt
; CHECK-LE-NEXT:    movs r1, #0
; CHECK-LE-NEXT:    rsbs.w r5, lr, #0
; CHECK-LE-NEXT:    bfi r1, r4, #0, #1
; CHECK-LE-NEXT:    sbcs.w r5, r3, lr, asr #31
; CHECK-LE-NEXT:    bfi r3, r4, #0, #8
; CHECK-LE-NEXT:    vmov r4, s4
; CHECK-LE-NEXT:    csetm r5, lt
; CHECK-LE-NEXT:    bfi r3, r5, #8, #8
; CHECK-LE-NEXT:    bfi r1, r5, #1, #1
; CHECK-LE-NEXT:    lsls r3, r3, #31
; CHECK-LE-NEXT:    it ne
; CHECK-LE-NEXT:    vldrne s0, [r2]
...
; CHECK-LE-NEXT:    sbcs.w r5, r2, r5, asr #31
; CHECK-LE-NEXT:    bfi r2, r3, #0, #8
; CHECK-LE-NEXT:    csetm r5, lt
; CHECK-LE-NEXT:    bfi r2, r5, #8, #8
; CHECK-LE-NEXT:    bfi r1, r5, #1, #1
...
; CHECK-BE-NEXT:    vrev64.32 q4, q2
; CHECK-BE-NEXT:    movs r1, #0
; CHECK-BE-NEXT:    vmov r2, s19
; CHECK-BE-NEXT:    vmov.i64 q0, #0xffffffff00000000
; CHECK-BE-NEXT:    vrev64.32 q3, q0
; CHECK-BE-NEXT:    vand q0, q1, q3
; CHECK-BE-NEXT:    rsbs r3, r2, #0
; CHECK-BE-NEXT:    vmov r3, s17
