...
; CHECK-NEXT:    rosbg %r1, %r0, 32, 55, 8
; CHECK-NEXT:    vlvgp %v0, %r1, %r0
; CHECK-NEXT:    vlvgf %v0, %r1, 0
; CHECK-NEXT:    vlvgf %v0, %r1, 2
; CHECK-NEXT:    vlvgp %v1, %r1, %r1
; CHECK-NEXT:    vlvgp %v2, %r0, %r1
; CHECK-NEXT:    lr %r0, %r1
; CHECK-NEXT:    nilh %r0, 255
; CHECK-NEXT:    chi %r0, 128
; CHECK-NEXT:    ipm %r0
; CHECK-NEXT:    vrepf %v1, %v1, 1
; CHECK-NEXT:    vgbm %v3, 30583
; CHECK-NEXT:    vn %v1, %v1, %v3
; CHECK-NEXT:    vlvgf %v2, %r0, 0
; CHECK-NEXT:    vlvgf %v2, %r0, 2
